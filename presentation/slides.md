---
theme: seriph
title: Présentation Travail fin d'étude Webdesign 2024-2025
aspectRatio: 16/9
class: text-center
drawings:
  persist: true
...
<div class="flex justify-center py-5">
  <img src="/assets/img/cahier-des-charges.png" class="w-100">
</div>
...
graph TD
    Accueil --> Boutique
    Boutique --> PageProduit["Page Produit"]
    Accueil --> CarteCadeau["Carte Cadeau"]
    Accueil --> APropos["à propos"]
    Accueil --> Contact
    Accueil --> SeConnecter["Se connecter"]
    SeConnecter --> SEnregistrer["S'enregistrer"]
    SeConnecter --> Compte
    Accueil --> Panier
    Panier --> PageCommander["Page Commander"] --> ValidationCommande["Validation de Commande"]
    ...
    classDef compteConnecte fill:#38bdf8,color:black;
    classDef condition fill:#f97316,color:white;

    class Accueil,Boutique,CarteCadeau,APropos,Contact,PageProduit menu;
    class Panier,PageCommander,ValidationCommande panier;
    class SeConnecter,SEnregistrer,Compte compte;
    class TableauDeBord,Commandes,Commande,Adresses,FormulaireAdresse,MoyensPaiement,FormulairePaiement,DetailsCompte,SeDeconnecter compteConnecte;
    class Page404 condition;
```
...
<div class="grid grid-cols-2 gap-6 place-items-center">
  <div class="flex flex-col items-center">
    ...
    <img src="/assets/img/bo-logo-v1.png" class="w-32 h-32 object-contain">
  </div>
  <div class="flex flex-col items-center">
    <p class="text-xs">Logo version 2 - Bo Only</p>
    <img src="/assets/img/bo-logo-v2-only.png" class="w-32 h-32 object-contain">
  </div>
  <div class="flex flex-col items-center">
    <p class="text-xs">Logo version 2 - Texte horizontal</p>
    <img src="/assets/img/bo-logo-v2-text-horizontal.png" class="w-56 h-56 object-contain">
  </div>
  <div class="flex flex-col items-center">
    <p class="text-xs">Logo version 2 - Texte vertical</p>
    <img src="/assets/img/bo-logo-v2-text-vertical.png" class="w-56 h-56 object-contain">
  </div>
</div>
...
<div class="flex justify-center py-5">
  <img src="/assets/img/components-ui.png" >
</div>
...
<div class="flex flex-col">
  <div class="flex flex-col">
    ...
    <img src="/assets/img/navbar-desktop.png" class="object-contain">
  </div>
  <div class="flex flex-col">
    <p class="text-xs font-bold" style="margin:0!important;">Navigation : Tablette</p>
    <img src="/assets/img/navbar-tablet.png" class="object-contain">
  </div>
  <div class="flex flex-col">
    <p class="text-xs font-bold" style="margin:0!important;">Navigation : Smartphone</p>
    <img src="/assets/img/navbar-smartphone.png" class="w-75 object-contain">
  </div>
</div>
...
<div class="flex justify-center py-5">
  <img src="/assets/img/technologies.png" class="w-150">
</div>
...
<div class="flex justify-center py-5">
  <img src="/assets/img/plugins.png" class="w-150">
</div>
